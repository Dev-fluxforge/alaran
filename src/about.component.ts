...
export class AboutComponent {
  team = signal<TeamMember[]>([
    { name: 'Dr. Adebayo Alaran', title: 'Founder & Chief Surveyor', imageUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=400&h=400', socials: { linkedin: '#', twitter: '#' } },
    { name: 'Chidinma Okoro', title: 'Head of Aerial Mapping', imageUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=400&h=400', socials: { linkedin: '#', twitter: '#' } },
    { name: 'Musa Bello', title: 'Lead Hydrographic Specialist', imageUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=400&h=400', socials: { linkedin: '#', twitter: '#' } },
    { name: 'Fatima Garba', title: 'Principal Cadastral Expert', imageUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=400&h=400', socials: { linkedin: '#', twitter: '#' } },
  ]);
